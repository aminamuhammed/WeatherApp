...
def home(request):
    ...
    url = f'https://api.openweathermap.org/data/2.5/weather?q={city}&appid=78a118b36747cd9b3f7867567b95f1bf'
    PARAMS = {'units':'metric'}

    API_KEY =  'AIzaSyDpMauFjf1UIJZgtJW2Dq6YkxZptq81JpM'

    SEARCH_ENGINE_ID = 'f1bd327426faf4973'
